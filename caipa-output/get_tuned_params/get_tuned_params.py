...
"""
    ...
    Objective:
        1. Encapsulate all configuration parameters
        2. Provide methods to render component directories and components
"""
import argparse
    ...
    def __init__(self, dictionary, **kwargs):
        ...
        for key, value in dictionary.items():
            if isinstance(value, dict):
                ...
                self.__setattr__(key, [NestedNamespace(i) if isinstance(i, dict) else i for i in value])
            else:
                self.__setattr__(key, value)


def print_best_parameters (project_id, hp_tune_job ,filename='tuned_params', common_args='[]'):
    # Store your full project ID in a variable in the format the API needs.
    #job_id = 'projects/{}/jobs/{}'.format('gcp-demo-2-262319','wd_hcr_hptuning_200221_0452' )
